...
import com.example.googlemap.model.LatitudeLongitutde;
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        List<LatitudeLongitutde> latLngs = new ArrayList<>();
        latLngs.add(new LatitudeLongitutde(27.7062581,85.3300012, "Mero Collge"));
        latLngs.add(new LatitudeLongitutde(27.70482,85.3293997, "Papu Vai ko Mo:Mo"));
